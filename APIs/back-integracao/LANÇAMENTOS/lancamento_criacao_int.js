...
app.post('/api/receberDadosLancamentoCriacao', async (req, res) => {
  ...
  try {
    ...
    // Verificando se os eventos são "lancamento_criacao_int" antes de inserir os dados
    if (dados.lancamentos.ITLA_CD_EVENTO !== 'lancamento_criacao_int') {
      throw new Error('O evento de lancamentos não é "lancamento_criacao_int"');
    }
    ...
    // Verificando se os eventos são "lancamento_criacao_int" antes de inserir os dados de 'lancamentosParcelas'
    if (Array.isArray(dados.lancamentos.lancamentosParcelas)) {
      if (!dados.lancamentos.lancamentosParcelas.every(parcela => parcela.ITLP_CD_EVENTO === 'lancamento_criacao_int')) {
        throw new Error('O evento de lancamentosParcelas não é "lancamento_criacao_int"');
      }
    }
    ...
    // Verificando se os eventos são "lancamento_criacao_int" antes de inserir os dados de 'lancamentosRubricas'
    if (Array.isArray(dados.lancamentos.lancamentosRubricas)) {
      if (!dados.lancamentos.lancamentosRubricas.every(rubricas => rubricas.ITLR_CD_EVENTO === 'lancamento_criacao_int')) {
        throw new Error('Um ou mais eventos de pagamentos não são "lancamento_criacao_int"');
      }
    }
