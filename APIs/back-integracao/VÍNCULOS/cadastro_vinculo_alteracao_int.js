...
app.post('/api/receberDadosCadastroVinculoAlteracao', async (req, res) => {
  ...
  if (dados.usuario !== 'CredorGIDEP' || dados.senha !== 'CredorUser10a20z30') {
    return res.status(401).json({ error: 'Usuário e Senha incorretos' });
          ...
          // Verifica se o campo ITCP_CD_EVENTO tem o valor "cadastro_vinculo_alteracao_int"
  if (dados.cadastrosPessoas.ITCP_CD_EVENTO !== "cadastro_vinculo_alteracao_int") {
