...
app.post('/api/receberDadosCadastroVinculoExclusao', async (req, res) => {
  ...
  // Verifica se o campo ITCP_CD_EVENTO tem o valor "cadastro_vinculo_exclusao_int"
  if (dados.cadastrosPessoas.ITCP_CD_EVENTO !== "cadastro_vinculo_exclusao_int") {
