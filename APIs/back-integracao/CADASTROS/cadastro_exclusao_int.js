...
app.post('/api/receberDadosCadastroExclusao', async (req, res) => {
  ...
  // Verifica se o campo ITCA_CD_EVENTO tem o valor "cadastro_exclusao_int"
  if (dados.cadastros.ITCA_CD_EVENTO !== "cadastro_exclusao_int") {
