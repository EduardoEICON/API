...
app.post('/api/receberDadosCadastroCriacao', async (req, res) => {
  ...
  if (dados.usuario !== 'CredorGIDEP' || dados.senha !== 'CredorUser10a20z30') {
    return res.status(401).json({ error: 'Usuário e Senha incorretos' });
      ...
      // Verifica se o campo ITCA_CD_EVENTO tem o valor "cadastro_criacao_int"
  if (dados.cadastros.ITCA_CD_EVENTO !== "cadastro_criacao_int") {
