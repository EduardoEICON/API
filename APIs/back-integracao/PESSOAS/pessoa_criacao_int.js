...
app.post('/api/receberDadosPessoaCriacao', async (req, res) => {
  ...
  // Verifica se o campo ITPE_CD_EVENTO tem o valor "pessoa_criacao_int"
  if (dados.pessoas.ITPE_CD_EVENTO !== "pessoa_criacao_int") {
