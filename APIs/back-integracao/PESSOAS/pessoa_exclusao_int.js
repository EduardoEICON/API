...
app.post('/api/receberDadosPessoaExclusao', async (req, res) => {
  ...
  // Verifica se o campo ITPE_CD_EVENTO tem o valor "pessoa_exclusao_int"
  if (dados.pessoas.ITPE_CD_EVENTO !== "pessoa_exclusao_int") {
